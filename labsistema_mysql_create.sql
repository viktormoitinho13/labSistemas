...
CREATE TABLE `LOJAS` (
	...
	`CNPJ_LOJA` varchar(15) NOT NULL UNIQUE,
...
CREATE TABLE `FABRICANTE` (
	...
	`CNPJ_FABRICANTE` varchar(15) NOT NULL,
...
ALTER TABLE `FABRICANTE` ADD CONSTRAINT `FABRICANTE_fk0` FOREIGN KEY (`ID_FABRICANTE`) REFERENCES `ESTOQUE`(`ID_ESTOQUE`);
