<div class="cadastro-form form-produto">
                    ...
                    <form action="{{url('cadastroproduto')}}" class="login__form" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" id="nome" name="nome_produto" placeholder="PARACETAMOL" required>
                            </div>
                            ...
                            <input type="date" id="nascimento" name="data_fabricacao" placeholder="11/02/1990" required>
                            </div>

                            <div>
                            <label class="titulo" for="datavencproduto">DATA DE VENCIMENTO</label>
                            <input type="date" id="nascimento" name="data_vencimento" placeholder="11/02/1990" required>
                            </div>
                            <div>
